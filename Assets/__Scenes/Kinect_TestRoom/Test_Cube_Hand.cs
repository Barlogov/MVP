...
public class Test_Cube_Hand : MonoBehaviour
{
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        GameObject handModel = Instantiate(handPref);
        handModel.name = $"HandModel {id}";

        // Поиск трансформов точек тела внутри объекта personModel

        ShoulderRight = handModel.transform.Find("ShoulderRight");
        ElbowRight = handModel.transform.Find("ShoulderRight/ElbowRight");
        WristRight = handModel.transform.Find("ShoulderRight/ElbowRight/WristRight");
        HandRight = handModel.transform.Find("ShoulderRight/ElbowRight/WristRight/HandRight");


        baseRotShoulderRight = ShoulderRight.rotation.eulerAngles;
        baseRotElbowRight = ElbowRight.rotation.eulerAngles;
        baseRotWristRight = WristRight.rotation.eulerAngles;
        baseRotHandRight = HandRight.rotation.eulerAngles;

        baseQuatShoulderRight = ShoulderRight.rotation;
    ...
    private void RefreshRotation(Kinect.Body body, GameObject bodyObject)
    {
        ...
        Vector3 ShoulderRight_JointV3 = new Vector3(body.Joints[Kinect.JointType.ShoulderRight].Position.X, body.Joints[Kinect.JointType.ShoulderRight].Position.Y, body.Joints[Kinect.JointType.ShoulderRight].Position.Z * -1);
        Vector3 ElbowRight_JointV3 = new Vector3(body.Joints[Kinect.JointType.ElbowRight].Position.X, body.Joints[Kinect.JointType.ElbowRight].Position.Y, body.Joints[Kinect.JointType.ElbowRight].Position.Z * -1);
        ...
        ShoulderRight.rotation = Quaternion.LookRotation(ElbowRight_JointV3 - ShoulderRight_JointV3, Vector3.right);
